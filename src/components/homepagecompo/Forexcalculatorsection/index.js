...
//             case 8:
//                 cards = [
//                     { Icon: Third, title: "Lorem Ipsum is simply", duration: "20-30 Days", cost: "Minimum deposit $ 20k", monthly: "$ 2,000.00", totalAmount: "20,000" },
...
//                 </div>
//                 <div className={styles.forexcalculatorstepsmdivmainalignmentmain}>
//                     <div className={styles.forexcalculatorstepsmdivmainalignment}>
...
export default function Forexcalculatorsection() {
  ...
  const handleCardSelection = (index, cost) => {
    ...
    if (cost === "-") {
      setTotalAmount(cost);
    } else if (cost.includes("Minimum deposit")) {
      setTotalAmount(parseFloat(cost.replace(/[^0-9]/g, "")) * 1000);
    } else {
      setTotalAmount(parseFloat(cost.replace(/[^0-9.-]+/g, "")));
    }
  };
        ...
        cards = [
          {
            ...
            duration: "03-04 Month",
            cost: "$ 8,000.00",
          },
          {
            Icon: Second,
            title: "Lorem Ipsum is simply",
            duration: "02-03 Month",
            cost: "$22,050.00",
          },
          {
            Icon: Third,
        ...
        <div className={styles.forexcalculatorpaymentcardsdivonefirst}>
          ...
          <div className={styles.radiobutton}>
            <div
              ...
              style={{
                backgroundColor:
                  selectedCard === index ? "#014EFF" : "transparent",
              }}
            ></div>
          </div>
        </div>
  ...
  return (
    <div className={styles.forexcalculatorsectionmain}>
      <div className={styles.forexcalculatorsectioncontainer}>
        ...
        <div className={styles.forexcalculatorstepsmdivmainalignmentmain}>
          <div className={styles.forexcalculatorstepsmdivmainalignment}>
            <div className={styles.forexcalculatorstepsmdivmain}>
              <div
                className={`${
                  styles.forexcalculatorstepsmdivmainsidelinesone
                } ${activeStep >= 0 ? styles.activeSideline : ""}`}
              ></div>
              {steps.map((step, index) => (
                <div
                  key={index}
                  className={`${styles.forexcalculatorboxes} ${
                    activeStep >= index ? styles.active : ""
                  }`}
                  onClick={() => handleClick(index)}
                >
                  <div
                    className={`${styles.forexcalculatorboxcircle} ${
                      activeStep >= index ? styles.activeCircle : ""
                    }`}
                  ></div>
                  <span>{step}</span>
                </div>
              ...
              <div
                className={`${
                  styles.forexcalculatorstepsmdivmainsidelinestwo
                } ${activeStep === 10 ? styles.activeSideline : ""}`}
              ></div>
            </div>
          </div>
        </div>
        ...
        <div className={styles.forexcalculatorpaymentsteps}>
          <div
            className={`${styles.forexcalculatorpaymentstepspreviusbutton} ${
              activeStep === 0
                ? styles.forexcalculatorpaymentstepspreviusbuttondisabled
                : styles.forexcalculatorpaymentstepspreviusbuttonenabled
            }`}
            title="back sloting"
            onClick={() => activeStep > 0 && handleClick(activeStep - 1)}
          >
          ...
          <div
            className={`${styles.forexcalculatorpaymentstepsnextbutton} ${
              activeStep === 10
                ? styles.forexcalculatorpaymentstepsnextbuttondisabled
                : styles.forexcalculatorpaymentstepsnextbuttonenabled
            }`}
            title="next sliding"
            onClick={() => activeStep < 10 && handleClick(activeStep + 1)}
          >
        ...
        <div className={styles.forexcalculatorpaymentstotalamount}>
          ...
          <div className={styles.forexcalculatorpaymentstotalamountprice}>
            <span title="slot total amount">
              {typeof totalAmount === "number"
                ? `$ ${totalAmount.toFixed(2)}`
                : totalAmount}
            </span>
            <button type="submit" aria-label="proceed">
              <p>Proceed</p>
              <Proceedicon />
            </button>
          </div>
          <div className={styles.forexcalculatorpaymentstotalamountpricebutton}>
            <button type="submit" aria-label="proceed">
              <p>Proceed</p>
              <Proceedicon />
            </button>
